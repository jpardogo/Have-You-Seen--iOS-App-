...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    while(i<n){
        ...
        for(j=0; j<4;j++){
            ...
            CGRect rect = CGRectMake(23+72*j, yy, 30, 44);
            UIButton *button=[[UIButton alloc] initWithFrame:rect];
            [button setFrame:rect];
            
            
            NSString *string=  [NSString stringWithFormat:@"http://www.myhost.nixiweb.com/smallimagesmovies/%@.png", item.filename];
            ...
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake((74*j), yy+48, 75, 12)];
